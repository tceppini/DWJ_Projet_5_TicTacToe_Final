            ...
            <div class="col-md-6">
                ...
                <div class="tic-tac-toe">
                    @foreach($locations as $index => $location)
                        <input class="player-{{$location["checked"] ? $location["type"] : $playerType}} {{$location["class"]}}"
                               id="block-{{$index}}" value="{{$index}}"
                               type="radio" {{$location["checked"] ? "checked" : ""}} {{$user->id != $nextTurn->player_id ? "disabled" : ""}}/>
